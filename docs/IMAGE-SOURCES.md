...
> **持ち帰った宿題**: 記事側の「物質形態」は13本とも`（要確認）`のまま。上の表で埋められるが、
> 出典が1つなので、もう1つの大手wikiと突き合わせてから直す（ファクトチェックの回で）。
> あわせて次の食い違いも確かめる。
> - 自サイト「執行の青春妄想」 ⇔ 一覧「漆黒の青春妄想」
> - 自サイト「ラスト・ローズ」 ⇔ 一覧には「ラストローズ」と「最後のバラ」の2つ
> - 「アストロ・コーラー」「喰心刃」は一覧に無い
