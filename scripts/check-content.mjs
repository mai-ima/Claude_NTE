...
const URL_BASE = {
  ...
  'endfield-gear': '/endfield/gear/',
  'endfield-industry': '/endfield/industry/',
  'endfield-enemies': '/endfield/enemies/',
  'endfield-areas': '/endfield/areas/',
  'endfield-systems': '/endfield/systems/',
