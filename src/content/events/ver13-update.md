---
title: "Ver.1.3「霧月夜に星還りて」アップデート"
kind: "event"
featured: ["残虹", "リンコ", "星暮保護区"]
version: "v1.3"
start: 2026-08-19
order: 1
...
sources:
  ...
  - label: "PR TIMES — Ver.1.3「霧月夜に星帰りて」8月19日より配信開始"
    url: "https://prtimes.jp/main/html/rd/p/000000034.000146166.html"
---

## 概要

**Ver.1.3「霧月夜に星還りて」** は **2026年8月19日**（メンテナンス後）に配信された大型アップデート。夏らしいビーチコンテンツと、本編ストーリーの新章が同時に来た回。

## 追加された主なもの

### 新エリア

- **[星暮保護区](/locations/hoshigure-sanctuary/)** — 山と湖、南に砂浜と港（星沈湾リゾート）。ストーリー進行の条件なしで入れる。

### 新ストーリー

- 本編**第6章「霧の巣遊戯」** を追加。**「赤竜討伐譚」クリア後**に解放される（→[メインストーリーの流れ](/story/main-story/)）。
...
- 前半: **蠱惑特別号**（[喰心刃](/arcs/kuishinjin/)）／**猛虎特別号**（[プリペア](/arcs/prepare/)復刻）
- 後半: **万波特別号**（[アストロ・コーラー](/arcs/astro-caller/)）／**名月特別号**
...
- 新しい乗り物（水上バイク Tide／ビーチバギー サウザン／自転車 ノスタルジー号）と不動産「閑野雅邸」
