...
**アストロ・コーラー** は Ver.1.3 後半で追加予定の[Sランク弧盤](/terms/arc/)。**[リンコ](/characters/rinko/)のモチーフ弧盤**で、物質形態は**プラズマ**（→[弧盤の物質形態](/terms/arc-forms/)）。

## 効果

- サポートスキルの連続発動と噛み合う効果を持ち、**スキル・EXレール終結の火力を底上げ**する。
- 具体的な倍率・発動条件は**要確認**（実装後に確定データへ更新）。
