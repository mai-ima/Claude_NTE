...
faction: "ピンクポウズ銀行（New Herland、ロビーマネージャー / 社員番号018888）"
...
**Chiz** はピンクポウズ銀行のロビーマネージャーで、**Cosmos 属性の近〜中距離アタッカー**。**最良の無料（F2P）DPS** と評価される。通常攻撃で都市通貨 **Fons** を稼ぎ、「チャートを読む」アルティメットで大ダメージを出す。
