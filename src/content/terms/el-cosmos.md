...
- 反応は交代（操作キャラの切り替え）と[連環値](/terms/renkan-value/)のメーターに連動して発動する。光のキャラの行動に隣接属性の行動を繋ぐことで反応が成立する。
...
- 実装キャラ例: [零](/characters/zero/)、[ちぃちゃん](/characters/chiz/)、[エドガー](/characters/edgar/)、[潯](/characters/hotori/)。
